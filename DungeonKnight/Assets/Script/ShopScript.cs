...
public class ShopScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int ii = 0; ii < card_Btn.Length; ii++)
        {
            ...
            card_Btn[ii].GetComponent<CardScript>().card_Type = (CardType)rand;
            card_Btn[ii].GetComponent<CardScript>().CardSetting();
            int gold = card_Btn[ii].GetComponent<CardScript>().card_Gold;
            card_GTxt[ii].text = "Gold : " + gold;
        }
        ...
        weapon_Txt.text = "Att + 5" + "\n\n" + "Gold : " + GlobalScript.g_ShopWeapon.ToString();
        shield_Txt.text = "Def + 3" + "\n\n" + "Gold : " + GlobalScript.g_ShopShield.ToString();
        armor_Txt.text = "Health + 15" + "\n\n" + "Gold : " + GlobalScript.g_ShopArmor.ToString();
        user_GTxt.text = "My Gold" + "\n\n" + GlobalScript.g_Gold.ToString();
